                ...
                <div style={styles.footerTop}>
                    <div style={styles.footerBrand}>
                        ...
                        <div style={styles.footerBrandText}>
                            Events, but make it clean.<span style={{ color: COLORS.green }}>.</span>
                        </div>
                            ...
                            {socialIcons?.map((s, idx) => (
                                ...
                                >
                                    <Media
                                        ...
                                        fallback={<span style={styles.socialFallback}>◎</span>}
                                    />
                                </a>
                            ))}
                        </div>
...
const styles = {
    ...
    footerBrandText: { marginTop: 10, color: COLORS.muted, lineHeight: 1.5 },
    ...
    socialIcon: { width: 16, height: 16, objectFit: "contain" },
    socialFallback: { color: COLORS.muted, fontWeight: 900 },
    ...
    footerColTitle: { fontWeight: 900, marginBottom: 10 },
    footerLinks: { display: "flex", flexDirection: "column", gap: 8 },
    footerLink: { color: COLORS.muted },
    ...
    legalRow: { display: "flex", gap: 12, flexWrap: "wrap" },
    legalLink: { color: COLORS.muted, fontWeight: 700, fontSize: 13 },
